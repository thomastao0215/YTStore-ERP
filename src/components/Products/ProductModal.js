...
class ProductEditModal extends Component {
  ...
  okHandler = () => {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        values['productDetail'] = this.state.productDetialList
        console.log(values)
        onOk(values);
  ...
  render() {
    ...
    const { productCategory,productName,price ,productDesc , brand,series,model ,productCode ,title, stock,sale,originPrice,origin,imgurl,banner,tags} = this.props.record;
